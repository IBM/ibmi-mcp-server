...
<Tip>
If you already have `DB2i_HOST`, `DB2i_USER`, and `DB2i_PASS` environment variables set, the CLI picks them up automatically — no additional configuration needed.
</Tip>
