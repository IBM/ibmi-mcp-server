...
```
User: "Show me the top CPU-consuming jobs"

AI Agent: [Calls get_active_jobs tool]
...
AI: "The QZDASOINIT job under QTCP is using the most CPU at 45,231 milliseconds..."
```
