...
<Info>
**Official Schema**: See the [JSON Schema definition](https://github.com/IBM/ibmi-mcp-server/blob/main/server/src/ibmi-mcp-server/schemas/json/sql-tools-config.json) for the authoritative toolset configuration specification.
</Info>
...
```bash
# Load single toolset
npx @ibm/ibmi-mcp-server@latest --tools tools/my-tools.yaml --toolsets performance_monitoring

# Load multiple toolsets (comma-separated)
npx @ibm/ibmi-mcp-server@latest --tools tools/my-tools.yaml --toolsets performance_monitoring,security_audit

# Load from environment variable
SELECTED_TOOLSETS=employee_information,payroll_processing
npx @ibm/ibmi-mcp-server@latest --tools tools/my-tools.yaml --toolsets $SELECTED_TOOLSETS
```
...
npx @ibm/ibmi-mcp-server@latest --list-toolsets --tools tools/my-tools.yaml
```
...
npx @ibm/ibmi-mcp-server@latest --tools tools/ --toolsets performance_monitoring,security_audit
```
...
**Start server:**
```bash
npx @ibm/ibmi-mcp-server@latest --tools tools/ --toolsets $SELECTED_TOOLSETS
```
