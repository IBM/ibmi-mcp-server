...
|----------|-------------|---------|-------|---------|
| `LLM_DEFAULT_MODEL` | Default model identifier | `google/gemini-2.5-flash` | - | `anthropic/claude-3.5-sonnet` |
| `LLM_DEFAULT_TEMPERATURE` | Sampling temperature (randomness) | Provider default | 0.0 - 2.0 | `0.7` |
| `LLM_DEFAULT_TOP_P` | Nucleus sampling threshold | Provider default | 0.0 - 1.0 | `0.9` |
| `LLM_DEFAULT_MAX_TOKENS` | Maximum tokens in response | Provider default | 1+ | `4000` |
| `LLM_DEFAULT_TOP_K` | Top-K sampling (candidates) | Provider default | 0+ | `40` |
| `LLM_DEFAULT_MIN_P` | Minimum probability threshold | Provider default | 0.0 - 1.0 | `0.05` |

<Accordion title="LLM Configuration Examples">
