...
import { tableFormatter, TableFormatter } from '../../../src/utils/formatting/tableFormatter.js';
...
describe('TableFormatter - NULL Handling', () => {
  ...
  describe('formatWithMetadata', () => {
    ...
    it('should work with different table styles', () => {
      ...
      // Test markdown style
      const mdResult = formatter.formatWithMetadata(data, { style: 'markdown' });
      ...
      // Test ascii style
      const asciiResult = formatter.formatWithMetadata(data, { style: 'ascii' });
  ...
  describe('Integration with truncation', () => {
    it('should handle NULLs with truncation enabled', () => {
      const data = [
        ...
        { id: 2, description: 'A very long description that will be truncated' },
      ];
